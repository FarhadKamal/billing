	...
	<div class="data">
		...
		<table border="0" style="width: 1000px;	font: 0.90em arial;">
			...
			<tr>
				...
				<td colspan=2>
					<input type="hidden" name="flow_type" class="text" value="<?php echo $this->validation->flow_type; ?>" />
				</td>
			</tr>
			...
			<tr>
				...
				<td align="left" align="left">
					<input type="text" name="amount" readonly class="text" value="<?php echo $this->validation->amount; ?>" /><br /> This is Auto generated after adding particular
				</td>
				...
				<table border="0" style="font: 0.90em arial;" bgcolor="#8CC5FF">
					...
					?>
						<tr>
							...
							<td colspan="2">Forward&nbsp;To&nbsp;<span style="color:red;">*</span>&nbsp;<select name="ReportingOfficer">
									<option value="account">Account</option>
