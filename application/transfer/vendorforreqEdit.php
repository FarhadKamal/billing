...
<div class="content">
	<div class="data">
		...
		<table border="0" style="width: 1000px;	font: 0.90em arial;">
			...
			<tr>
				<?php $net_amount = $this->validation->amount - $this->validation->tds - $this->validation->vds - $this->validation->advance - $this->validation->tot_auth_deduction - $this->validation->general_deduction; ?>
				<td>Net Amount:</td>
