...
class BillauditModel extends ci_model
{
	...
	function get_paged_list($limit = 10, $offset = 0)
	{
		...
		if (strtolower($this->session->userdata('username')) == 'tanjim' or strtolower($this->session->userdata('username')) == 'musa' or strtolower($this->session->userdata('username')) == 'reza2') {
