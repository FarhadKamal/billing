...
class RequestModel extends ci_model
{
	...
	function get_search_req_conveyance_audit_list($company)
	{
		...
		if (strtolower($this->session->userdata('username')) == 'pdhlac' or strtolower($this->session->userdata('username')) == 'pdhlac2') {
			...
			$query = $this->db->query("select tb_empinfo.vEmpName,mis_conveyance.*,tb_companylist.vCompany  from mis_conveyance
		inner join tb_empinfo on tb_empinfo.vEmpId=mis_conveyance.EmpId
		inner join tb_companylist on tb_companylist.iId=mis_conveyance.company
		where  mis_conveyance.company  in(4,14,12,9) and  status=1 and loc=" . $loc . " and mis_conveyance.company=" . $company . " order by mis_conveyance.SL asc ");
		} else if (strtolower($this->session->userdata('username')) == 'gep') {

			$query = $this->db->query("select tb_empinfo.vEmpName,mis_conveyance.*,tb_companylist.vCompany  from mis_conveyance
		inner join tb_empinfo on tb_empinfo.vEmpId=mis_conveyance.EmpId
		inner join tb_companylist on tb_companylist.iId=mis_conveyance.company
		where  mis_conveyance.company  in(6) and  status=1 and loc=" . $loc . " and mis_conveyance.company=" . $company . " order by mis_conveyance.SL asc ");
		} else if (strtolower($this->session->userdata('username')) == 'pnlaccount') {
		...
		inner join tb_empinfo on tb_empinfo.vEmpId=mis_conveyance.EmpId
		inner join tb_companylist on tb_companylist.iId=mis_conveyance.company
		where  mis_conveyance.company  in(1) and  status=1 and loc=" . $loc . " and mis_conveyance.company=" . $company . " order by mis_conveyance.SL asc ");
		} else if (strtolower($this->session->userdata('username')) == 'nizam') {

			$query = $this->db->query("select tb_empinfo.vEmpName,mis_conveyance.*,tb_companylist.vCompany  from mis_conveyance
		inner join tb_empinfo on tb_empinfo.vEmpId=mis_conveyance.EmpId
		inner join tb_companylist on tb_companylist.iId=mis_conveyance.company
		where  mis_conveyance.company  in(7,3) and  status=1 and loc=" . $loc . " and mis_conveyance.company=" . $company . " order by mis_conveyance.SL asc ");
		} else if (strtolower($this->session->userdata('username')) == 'azaccount') {

			$query = $this->db->query("select tb_empinfo.vEmpName,mis_conveyance.*,tb_companylist.vCompany  from mis_conveyance
		inner join tb_empinfo on tb_empinfo.vEmpId=mis_conveyance.EmpId
		inner join tb_companylist on tb_companylist.iId=mis_conveyance.company
		where  mis_conveyance.company  in(18) and  status=1 and loc=" . $loc . " and mis_conveyance.company=" . $company . " order by mis_conveyance.SL asc ");
		} else {

			$query = $this->db->query("select tb_empinfo.vEmpName,mis_conveyance.*,tb_companylist.vCompany  from mis_conveyance
		inner join tb_empinfo on tb_empinfo.vEmpId=mis_conveyance.EmpId
		inner join tb_companylist on tb_companylist.iId=mis_conveyance.company
		where mis_conveyance.company not in(4,14,7,12,9) and status=1 and loc=" . $loc . " and mis_conveyance.company=" . $company . " order by mis_conveyance.SL asc ");
		}
