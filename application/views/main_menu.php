			...
			<ul>
				...
				<?php if ($userlevel == 5 or $userlevel == 6) { ?>
					<li>
						...
						<ul>
							...
							<li>
								<a href='<?php echo base_url(); ?>index.php/bill/general/ticket/'><img style='vertical-align: middle' width=15 height=15 src='<?php echo base_url(); ?>/images/menu/reports.png' border=0 hspace=3>Claim&nbsp;General&nbsp;Bill&nbsp;Against&nbsp;Service&nbsp;Ticket&nbsp;</a>
							</li>
				...
				<li>
					...
					<ul>
						...
						<?php if (
							$userlevel == 1  or  $this->session->userdata('username') == 1109 or $this->session->userdata('username') == 1775 or $this->session->userdata('username') == 1508 or $this->session->userdata('username') == 1091  or $this->session->userdata('username') == 1936 or $this->session->userdata('username') == 1580  or $this->session->userdata('username') == 2346 or $this->session->userdata('username') == 2405
				...
				-->
						...
						<?php if ($userlevel == 7) { ?>
							...
							<?php } ?>
							<?php if (strtolower($this->session->userdata('username')) != 'amar' and strtolower($this->session->userdata('username')) != 'sharma' and strtolower($this->session->userdata('username')) != 'aman' 
							and strtolower($this->session->userdata('username')) != 'dhkhead' 
							and strtolower($this->session->userdata('username')) != 'haldahead'     and   strtolower($this->session->userdata('username')) != 'azhead') {  ?>
								<li>
									<a href='<?php echo base_url(); ?>index.php/bill/admin/billList'><img style='vertical-align: middle' width=15 height=15 src='<?php echo base_url(); ?>/images/menu/benefitInformation.png' border=0 hspace=3>All&nbsp;Bill&nbsp;List</a>
								</li>
							<?php } ?>
				...
				<li>
					...
					<?php if ($userlevel != 666) { ?>
						...
						<ul>
							...
							<?php if ($userlevel == 1   or  $this->session->userdata('username') == 2283 or  $this->session->userdata('username') == 2540   or  $this->session->userdata('username') == 1109 or $this->session->userdata('username') == 1661  or $this->session->userdata('username') == 2346) { ?>
							...
							<?php if ($userlevel == 8) { ?>
								...
								<?php if (strtolower($this->session->userdata('username')) == 'scost') { ?>
									...
									<li>
										<a target="about_blank" href='<?php echo base_url(); ?>index.php/reports/reports/pending_cheque_com/24'><img style='vertical-align: middle' width=15 height=15 src='<?php echo base_url(); ?>/images/menu/benefitInformation.png' border=0 hspace=3>Pending&nbsp;Bill&nbsp;For&nbsp;Cheque Cross ltd</a>
									</li>

									<li>
										<a target="about_blank" href='<?php echo base_url(); ?>index.php/reports/reports/pending_cash/24'><img style='vertical-align: middle' width=15 height=15 src='<?php echo base_url(); ?>/images/menu/benefitInformation.png' border=0 hspace=3>Pending&nbsp;Bill&nbsp;For&nbsp;Cash Cross ltd</a>
									</li>
								...
								<?php if (strtolower($this->session->userdata('username')) == 'scost') { ?>
									...
									<li>
										<a target="about_blank" href='<?php echo base_url(); ?>index.php/reports/reports/pending_cheque_com/24'><img style='vertical-align: middle' width=15 height=15 src='<?php echo base_url(); ?>/images/menu/benefitInformation.png' border=0 hspace=3>Cheque&nbsp;Bill&nbsp;For&nbsp;Cross&nbsp;ltd</a>
									</li>
								<?php } ?>
