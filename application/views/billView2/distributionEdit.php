	...
	<div class="data">
		...
		<table border="0" style="width: 1000px;	font: 0.90em arial;">
			...
			<tr>
				...
				<td align="left" align="left">
					<input type="text" name="amount" id="contractual_text" class="text" value="<?php echo $this->validation->amount; ?>" />
					&nbsp;Contractual&nbsp;<input name="contractual_status" id="contractual_checkbox" value="1" <?php if ($this->validation->contractual_status == 1) echo "checked"; ?> type="checkbox" />
				</td>
			</tr>
