...
<body>
	...
	<?php echo anchor('bill/reqsup/requisitionList/','refresh',array('class'=>'view')); ?>
		<h1 valign="top"><?php  echo $title; ?></h1><?php echo $message; ?>
			...
			<div class="paging">
				...
				&nbsp;&nbsp;&nbsp;<input type="submit" value=">>"/><input type="hidden" name="condition" value="1"></td>
				</tr>
				</table>
				<?php echo form_close(); ?>
				...
				<?php echo form_open_multipart($action); ?>
				<table><tr><td><font color='BLUE'>Requisition&nbsp;ID</font></td>
				<td><input type="text"  name="reqid" value=""/>
