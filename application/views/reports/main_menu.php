				...
				<li>
					...
					<?php if ($userlevel != 666) { ?>
						...
						<ul>
							...
							<?php if ($userlevel == 1   or  $this->session->userdata('username') == 2283 or  $this->session->userdata('username') == 3540   or  $this->session->userdata('username') == 1109 or $this->session->userdata('username') == 1661  or $this->session->userdata('username') == 2346) { ?>
