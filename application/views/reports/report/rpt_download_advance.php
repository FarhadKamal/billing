...
<table border="0"  CELLPADDING="0" CELLSPACING="0" width="80%" align="center" valign="top" >
	<tr><td align="Center" ><b>Advance Report Date Wise</b></td></tr> 
	...
	<table border="1"   CELLPADDING="0" CELLSPACING="0" width="80%" align="center" align="center" >	
		...
		<tr>
			...
			<td align="Center"><b>Advance-ID</b></td>
			<td align="Center"><b>Company</b></td>
			<td align="Center"><b>Advance-Date</b></td>
			...
			<td align="Center"><b>Cheque_Payment_Date</b></td>
			<td align="Center"><b>Cash_Payment_Date</b></td>
	...
	$sl=$sl+1;
	$view='&nbsp<a href="'.base_url().'index.php/reports/reports/view_advance/'.$mydata->id.'" target="about_blank" class="view">view</a>'.'<br/>';
	
	$Status="Pending";
	
	if($mydata->cancel_staus==0){
	...
	?>	
		...
		<td align="center"><b><?php echo $mydata->advance_date ?></b></td>
		<td align="center"><b><?php echo $mydata->advance_description ?></b></td>	
		...
		<td align="center"><b><?php echo $mydata->advance_type ?></b></td>
		<td align="center"><b><?php if($mydata->cancel_staus==0) echo $mydata->cheque_payment_date ?></b></td>
		<td align="center"><b><?php if($mydata->cancel_staus==0) echo $mydata->cash_payment_date ?></b></td>
