...
?>
	<table border="0"  CELLPADDING="0" CELLSPACING="0" width="30%"  valign="top" >
		<tr>
				...
				<td>Print Date:&nbsp;<?php echo $mydata->cursdate;    //date('l jS \of F Y h:i:s A'); ?>
				<br/>
				<?php echo $mydata->vEmpName;    //date('l jS \of F Y h:i:s A'); ?>
				<br/>
				Employee ID:&nbsp;<?php echo $mydata->created_by;    //date('l jS \of F Y h:i:s A'); ?>
				<br/>
				Company:&nbsp;<?php echo $mydata->vCompany; ?>
				<br/> I received tk.&nbsp;<b><?php echo $netpay ?></b><b>&nbsp;(<?php echo convert_number($netpay); ?>&nbsp;taka&nbsp;only) against Sap Id No&nbsp;<?php echo $mydata->sap_id ?></b></td>
		</tr>
	</table>
