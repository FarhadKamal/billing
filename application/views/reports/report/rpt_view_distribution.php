...
$loc="";
			...
			else if($mydata->loc==2) $loc="Dhaka Head Office";
...
?>
	<table border="1"  CELLPADDING="0" CELLSPACING="0" width="80%" align="center" valign="top" >
		...
		<tr>
				...
				<td  align="left"><b><?php echo $mydata->amount;  if($mydata->contractual_status==1)echo "&nbsp;Contractual"; ?></b></td>
		</tr>
		<tr>
...
<table border="0"  CELLPADDING="0" CELLSPACING="0" width="80%" align="center" valign="top" >
	...
	<table border="1"   CELLPADDING="0" CELLSPACING="0" width="80%" align="center" align="center" >	
		...
		<tr>
			...
			<td align="Center"><b>Pump&nbsp;Model</b></td>
			<td align="Center"><b>Quantity</b></td>
			<?php if($mydata->contractual_status==0){ ?>
			<td align="Center"><b>Amount&nbsp;BDT</b></td>
			<?php } ?>
			<td align="Center"><b>Referance</b></td>		
		</tr> 
	<?php 
	echo $table3;
	?>
