...
?>
	<table border="0"  CELLPADDING="0" CELLSPACING="0" width="30%"  valign="top" >
		<tr>
				...
				<br/>
				ID:&nbsp;<?php echo $mydata->req_by; ?>
				<br/>
				Designation:&nbsp;<?php echo $mydata->vDesignation; ?>
				<br/>
				Department:&nbsp;<?php echo $mydata->vDepartment; ?>
				<br/> I received tk.&nbsp;<b><?php echo $netpay ?></b><b>&nbsp;(<?php echo convert_number($netpay); ?>&nbsp;taka&nbsp;only) on account of&nbsp;<?php echo $mydata->advance_description ?></b></td>
		</tr>
	</table>
