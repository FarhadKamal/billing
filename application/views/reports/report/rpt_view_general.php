...
?>
	<table border="1"  CELLPADDING="0" CELLSPACING="0" width="80%" align="center" valign="top" >
		...
		<tr>
				...
				<td  align="left" ><b><?php echo $mydata->id ?></b>&nbsp;&nbsp;&nbsp;<b><?php if($mydata->invoice_type=='Recurring') echo $mydata->invoice_type; ?></b></td>
		...
		<tr>
				...
				<td  align="left" ><b>Advance:&nbsp;<?php echo $mydata->advance ?></b></td>
				<td  align="left"><b>Amount:&nbsp;<?php echo $mydata->amount ?></b></td>
		</tr>
...
<br/>
<table border="0"  CELLPADDING="0" CELLSPACING="0" width="80%" align="center" valign="top" >
	<tr><td align="Center" ><b>Bill Details</b></td></tr> 
	</table>
	<table border="1"   CELLPADDING="0" CELLSPACING="0" width="80%" align="center" align="center" >	
		...
		<tr>
			...
			<td align="Center"><b>Particular&nbsp;Date</b></td>
