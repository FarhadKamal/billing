	...
	<div class="content" style="width:900; " valign="top" align="left" >
		<h1 valign="top"><?php  echo $title; ?></h1><?php echo $message; ?>
			...
			<div class="paging">
				...
				<tr>
						<td><font color='BLUE'>Search&nbsp;By:</font></td>
						<td>
							<select name="so">
								
								<option value="mis_advance.amount"  <?php if($this->input->post('so')=="mis_advance.amount") echo "selected"; ?>   >Amount</option>
								<option value="mis_advance.advance_description"  <?php if($this->input->post('so')=="mis_advance.advance_description") echo "selected"; ?>   >Description</option>
											
						 <input type="text" name="sv" size="40" value="<?php echo $this->input->post('sv'); ?>" /></td>
					</tr>
				
				
				
				<tr><td><font color='BLUE'>From&nbsp;Date:</font></td>
