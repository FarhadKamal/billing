...
<div class="content">
    ...
    echo "selected";
				...
				<td>Bill&nbsp; Type<span style="color:red;"></span></td>
				<td>
					<select name="invoice_type">
						<option value="General" <?php if ($this->validation->invoice_type == "General") {
    echo "selected";
} ?>>General
							Bill
						</option>
						<option value="Recurring" <?php if ($this->validation->invoice_type == "Recurring") {
    echo "selected";
} ?>>Recurring
							Bill
						</option>
			...
			<tr>
				...
				<td colspan=2>
					<input type="hidden" name="flow_type" class="text"
						value="<?php echo $this->validation->flow_type; ?>" />
				</td>
			</tr>
			...
			<tr>
				...
				<td align="left" align="left">
					<input type="text" name="amount" readonly class="text"
						value="<?php echo $this->validation->amount; ?>" /><br />
					This is Auto generated after adding particular
				</td>
		...
		<table border="0" style="font: 0.90em arial;" bgcolor="#8CC5FF">
			<tr>
				<td align="left">
					...
					<?php if ($this->validation->flow_type == "Ticket") { ?>

					Ticket&nbsp;No&nbsp;

					<input type="number" maxlength="8" name="particular" />
					<?php } else { ?>
