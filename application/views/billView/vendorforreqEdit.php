...
<style type="text/css">
	...
	value="<?php echo base_url(); ?>index.php/bill/vendorforreq/" />
    ...
    echo "selected";
			...
			<tr>
				...
				<td align="left" align="left">
					<input type="text" name="bill_date" readonly onclick="displayDatePicker('bill_date');" class="text"
			...
			<tr>
				...
				<td align="left" align="left">
					<input type="text" name="po_no" class="text"
						value="<?php echo $this->validation->po_no; ?>" />
					<?php echo $this->validation->po_no_error; ?>
				</td>
				<td align="left">PO&nbsp;Date:&nbsp;<span style="color:red;">*</span></td>
				<td align="left" align="left">
					<input type="text" name="po_date" readonly onclick="displayDatePicker('po_date');" class="text"
						value="<?php echo $this->validation->po_date; ?>" />
					<a href="javascript:void(0);" onclick="displayDatePicker('po_date');"><img
							src="<?php echo base_url(); ?>style/images/calendar.png"
							alt="calendar" border="0"></a>
			...
			<tr>
				...
				<td align="left" align="left">
					<input type="text" name="gr_no" class="text"
						value="<?php echo $this->validation->gr_no; ?>" />
					<?php echo $this->validation->gr_no_error; ?>
				</td>
				<td align="left">GR&nbsp;Date:&nbsp;<span style="color:red;">*</span></td>
				<td align="left" align="left">
					<input type="text" name="gr_date" readonly onclick="displayDatePicker('gr_date');" class="text"
						value="<?php echo $this->validation->gr_date; ?>" />
					<a href="javascript:void(0);" onclick="displayDatePicker('gr_date');"><img
							src="<?php echo base_url(); ?>style/images/calendar.png"
							alt="calendar" border="0"></a>
			...
			<tr>
				...
				<td align="left" align="left">
					<input type="text" name="iv_no" class="text"
						value="<?php echo $this->validation->iv_no; ?>" />
					<?php echo $this->validation->iv_no_error; ?>
				</td>
				<td align="left">IV&nbsp;Date:&nbsp;<span style="color:red;">*</span></td>
				<td align="left" align="left">
					<input type="text" name="iv_date" readonly onclick="displayDatePicker('iv_date');" class="text"
						value="<?php echo $this->validation->iv_date; ?>" />
					<a href="javascript:void(0);" onclick="displayDatePicker('iv_date');"><img
							src="<?php echo base_url(); ?>style/images/calendar.png"
							alt="calendar" border="0"></a>
			...
			<tr>
				...
				<td align="left" align="left">
					<input type="text" name="asset_no" class="text"
						value="<?php echo $this->validation->asset_no; ?>" />
		...
		<table border="0" style="width: 1000px;	font: 0.90em arial;">
			...
			<tr>
				...
				<td align="left" align="left">
					<input type="text" name="general_deduction" class="text"
						value="<?php echo $this->validation->general_deduction; ?>" />
					<?php echo $this->validation->general_deduction_error; ?>
				</td>
				<td align="left">General&nbsp;Deduction&nbsp;Note&nbsp;<span style="color:red;"></span></td>
				<td align="left">
					<textarea rows=3 name="general_deduction_note"
						cols=40><?php echo $this->validation->general_deduction_note; ?></textarea>
		...
		<table border="0" style="width: 1000px;	font: 0.90em arial;">
			...
			<tr>
				...
				<td align="left" align="left">
					<input type="text" name="retypeamount" class="text"
						value="<?php echo $this->validation->retypeamount; ?>" />
